<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{route('presence.index')}}" class="brand-link">
        <img src="../../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">{{__('site.system_company')}}</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="{{route('presence.profile',['id'=>auth()->user()->id])}}" class="d-block">{{auth()->user()->name}}</a>
            </div>
        </div>
...
{{--                     with font-awesome or any other icon font library -->--}}
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('getcalender',['id'=>auth()->user()->id])}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Calender</p>
                            </a>
                        </li>
